...
// Popular Games
const popularGames = `/games?dates=${lastYear},${currentDate}&ordering=-rating&page_size=6`;
// Upcoming Games
const upcomingGames = `/games?dates${currentDate},${nextYear}&ordering=-added&page_size=6`;
// New Games
